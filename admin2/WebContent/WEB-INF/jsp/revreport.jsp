...
<head>
   ...
   <title>    <c:out value="${Client_Agent_SubAgent_Name}">  </c:out>  's Reports </title>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>     <c:out value="${Client_Agent_SubAgent_Name}">  </c:out>  's Revenue Report
                    ...
                    <!--   before  table -->
                         ...
                         <div class="tab-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header"> <p> There is no report to show right now</p>
                         ...
                         <!--   loading options start here -->  
                                   <div class="row">
                                      <!--  <div class="col-md-3">
                                        ...
                                        <a href="/frombank">
<div class="mb-3 card card-body"><h5 align="center" class="card-title">TRANSFER FROM</h5><div class="font-icon-wrapper"><i class="fa fa-university fa-1x" aria-hidden="true" style="color:black"></i>
</br>
<p>BANK</p> 
                                                        </div>
...
<p>VISA</p> 
                                        ...
                                        <a href="#">
<div class="mb-3 card card-body"><h5 align="center" class="card-title">TRANSFER FROM</h5><div class="font-icon-wrapper"><i class="fa fa-btc fa-1x" aria-hidden="true" style="color:black"></i>
</br>
<p>BITCOIN</p> 
                                                        </div>

                                        ...
                                        <form class="">
                                            <div class="form-row">
                                                ...
                                                <input name="username"    id="userpk" value=" <c:out value="${UserName_UserID}"> </c:out>   "  type="hidden"  > 
                                                    ...
                                                    <div class="position-relative form-group"><label for="username" class="">Account Number</label>  </br>
                                                    <div class="col-md-3">
                                            ...
                                            <div class="form-row">
                                              ...
                                              <div class="form-row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="position-relative form-group"><label for="username" class="">Amount</label><input name="User Name" id=" "  type="text" class="form-control"></div>
                                                </div>
                                         ...
                                         <div class="form-row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="position-relative form-group"><label for="username" class="">Currency</label><input name="User Name" id="balancepk"  type="text" class="form-control"></div>
                                                </div>
                                           ...
                                           <div class="form-row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="position-relative form-group"><label for="username" class="">Reference Number</label><input name="User Name" id="balancepk"  type="text" class="form-control"></div>
                                                </div>

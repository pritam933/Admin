...
<head>
   ...
   <title>   Cryptocurrency Load </title>
...
<body onload="cryptohistory();">
  ...
  <li class="app-sidebar__heading">Sponsored Accounts</li>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>     <c:out value="${Client_Agent_SubAgent_Name}">  </c:out>  's Crypto Load
                 ...
                 <div class="col-md-3"> 
                       ...
                       <input type="hidden" id="seelingcurrency" value="BTC">
                       <input type="hidden" id="cusername" value="  <c:out value="${UserName_UserID}"> </c:out> ">
                       <input type="hidden" id="cagent" value=" <c:out value="${Admin_Agent_code}"></c:out> ">
                       <input type="hidden" id="csubagent" value="  <c:out value="${Admin_Sub_Agent_code}"></c:out> ">
                       <input type="hidden" id="cemail" value="  <c:out value="${Email_ID}"></c:out> ">
                     
                       
                       
                            
                              <div class="position-relative form-group"><label for="exampleCustomSelect" class=""><strong>Currency</strong> </label><select type="select" name="sender"  id="currencybtc" class="custom-select">
                            ...
                            <label for="exampleCity" class=""><strong>Amount</strong></label>
                            
                            <input name="amount"  id="btcamount" placeholder=" " type="number" class="form-control"  > 
                            <p><span style="color: rgb(243, 121, 52);"><strong>Enter Amount $50.00 to $5,000.00 . For larger amount email support.</strong></span></p>
                            
                            	 <button type="button" class="btn btn-primary mt-4" onclick="getquote()" >Initiate Load</button>
   ...
   <div class="form-row">
	...
	<div class="col-md-5">
	      ...
	      <a id="link" href="#"><img id="chart" src="" alt="QR code" /></a>
	
	                               
	  
	   <input type="hidden" id="size" value="200x200">
	  

	  
	    <input type="hidden" id="text" value="   "  required >
	   </br>
	  
	    <button data-theme="b" class="btn btn-primary mt-4" onclick="setChartImage()">Generate QR</button>
	    
	  
	    
	    <input type="hidden" id="trid" value= " ">
	  
	   <button data-theme="b" class="btn btn-primary mt-4" onclick="getstatus()">Get Transaction Status</button>
                                ...
                                <p><strong><span style="color: rgb(41, 105, 176);"><span>Crypto Transaction History</span> &nbsp;</span></strong></p>	
                                    ...
                                    <div class="table-responsive">
                                      ...
                                      <table id="table" border="1" class="mb-0 table table-bordered" ><caption></caption>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center" id="damount"> Requested Amount		</th>
                                                
                                                <th class="text-center" id="SourceCurrencyCode">  	Requested Currency	</th>
                                                <th class="text-center" id="DateCreate">    Transaction Date	</th>
                                               <th class="text-center" id="TransactionRequestID">Transaction ID</th>
                                               <th class="text-center" id="TransactionRequestStatus"> Status</th> 
    ...
    <script type="text/javascript" src="assets/scripts/dashboard.js"></script>
       <script type="text/javascript" src="assets/scripts/activity.js"></script>
        ...
        <script type="text/javascript" src="assets/scripts/crypto.js"></script>

...
<head>
   ...
   <title>    <c:out value="${Client_Agent_SubAgent_Name}">  </c:out>  's Card Activity </title>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>     <c:out value="${Client_Agent_SubAgent_Name}">  </c:out>  's Card Activity
                    ...
                    <!--   before  table -->
                         ...
                         <div class="tab-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header">  Card Activity

...
<head>
   ...
   <title>    <c:out value="${Client_Agent_SubAgent_Name}">  </c:out>  's Activity </title>
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                ...
                                <div class="widget-content-right header-user-info ml-3">
                                    <a href="login.jsp"  class="mt-2 btn">  <button type="button" tabindex="0" class="mt-2 btn btn-primary">Log Out</button> </a>
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                   <li class="app-sidebar__heading">Dashboard</li>
                                    <li>
                                        <a href="dashboard2.jsp" class="mm-active">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="table-responsive">
                                              ...
                                              <div class="col-md-3"><label class="mb-2 mr-2 badge badge-primary" for="exampleCustomSelect" class="">Choose Account Below</label><select type="select" name="sender"  id="masteracc" class="custom-select">
                                                                <option value="">Select Account here</option>
                                                                <option>56864212 </option>
                                                               <!--  <option>56864212 </option> -->
                                                               ...
                                                               <div class=" position-relative form-group  "><label class="mb-2 mr-2 badge badge-primary" for="exampleCustomSelect" class="">Choose Date Range Below</label>
